...
wait(3)
local Window = OrionLib:MakeWindow({Name = "北约系统", HidePremium = false, SaveConfig = false, IntroText = "正在启动(密钥系统)", ConfigFolder = "密钥系统"})
...
function wrong02()
  OrionLib:MakeNotification({
    Name = "很抱歉，你没有添加密钥用户",
    Content = "请联系我们的作者，也可以加群，获得密钥用户， QQ群号:822067998",
    Image = "rbxassetid://7734042071",
    Time = 10
  })
end
...
function yhm1()
  if playername == "cccccccc666657" then
    if Input == "1234" then
      load()
     else
      wrong()
...
function yhm2()
  if playername == "smalldogjia" then
    if Input == "2994" then
      load()
     else
      wrong()
...
--验证区
Key:AddParagraph("想要密钥请加北约QQ官方群:822067998","")
...
Igkvd:AddButton({
	Name = "北洋中心",
	Callback = function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/xkpvp/-/main/Protected.lua%20(3).txt"))()
	 end
})
...
Igkvd:AddButton({
	Name = "你家坤能飞多远？",
	Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/JumbleBumble/Scripts/main/HowFarCanYourBirdFly.lua",true))()
    end
})

About:AddParagraph("作者的留言","欢迎草尼马")
 
About:AddParagraph("北约中QQ官方群","822067998")
 
About:AddButton({
  Name = "北约QQ官方群(点击复制)",
  Callback = function()
    setclipboard("822067998")
  end
})
